...
namespace TextSplit
{
    ...
    public partial class TextSplitForm : Form, ITextSplitForm
    {
        ...
        readonly private int filesQuantity = DConst.FilesQuantity;
        readonly private int filesQuantityPlus = DConst.ToDoQuantity;
        readonly private int showMessagesLevel = DConst.ShowMessagesLevel;
